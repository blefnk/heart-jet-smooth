...
- **🚀 Live Demo**: [heart-jet-smooth.vercel.app](https://heart-jet-smooth.vercel.app/en)
- **💙 Discord**: [discord.gg/Pb8uKbwpsJ](https://discord.gg/Pb8uKbwpsJ)
- **📚 Docs**: [docs.reliverse.org](https://docs.reliverse.org/heart-jet-smooth)
...
1. `git clone https://github.com/blefnk/heart-jet-smooth.git`
2. `cd heart-jet-smooth`
3. `bun i`
